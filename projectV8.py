...
while draw:
    ...
    scaleM2 = pyrr.matrix44.create_from_scale(np.array([scale2,
                                                       scale2,
                                                       scale2]))
    rotateZM2 = pyrr.matrix44.create_from_z_rotation(np.deg2rad(0))
    rotateYM2 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))# + rotY2))
    #rotateYM2 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))
    rotateXM2 = pyrr.matrix44.create_from_x_rotation(np.deg2rad(0))
    #print(rotY2)
    ...
    scaleM3 = pyrr.matrix44.create_from_scale(np.array([scale3,
                                                        scale3,
                                                        scale3]))
    rotateZM3 = pyrr.matrix44.create_from_z_rotation(np.deg2rad(0))
    rotateYM3 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))
    rotateXM3 = pyrr.matrix44.create_from_x_rotation(np.deg2rad(0 + rotY3))
    ...
    scaleM4 = pyrr.matrix44.create_from_scale(np.array([scale4,
                                                        scale4,
                                                        scale4]))
    rotateZM4 = pyrr.matrix44.create_from_z_rotation(np.deg2rad(0))
    rotateYM4 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))
    rotateXM4 = pyrr.matrix44.create_from_x_rotation(np.deg2rad(0 + rotY4))
    ...
    scaleM5 = pyrr.matrix44.create_from_scale(np.array([scale5,
                                                        scale5,
                                                        scale5]))
    rotateZM5 = pyrr.matrix44.create_from_z_rotation(np.deg2rad(0))
    rotateYM5 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))
    rotateXM5 = pyrr.matrix44.create_from_x_rotation(np.deg2rad(0))
    ...
    scaleM6 = pyrr.matrix44.create_from_scale(np.array([scale6,
                                                        scale6,
                                                        scale6]))
    rotateZM6 = pyrr.matrix44.create_from_z_rotation(np.deg2rad(0))
    rotateYM6 = pyrr.matrix44.create_from_y_rotation(np.deg2rad(180))
    rotateXM6 = pyrr.matrix44.create_from_x_rotation(np.deg2rad(0))
